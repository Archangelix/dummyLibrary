...
class ABLoginTest extends FlatSpec with Matchers with MockitoSugar {

  val SALTED_ADMIN_PASSWORD = "[B@249a39df|fae50dfd4903e8e2faf931fc11784430f46418e2fd7f39d21ab6615b12262f19"
    
  class TestController extends Controller with ABLogin {
  ...
  "The guest" should "have access to main page" in {
    ...
    contentAsString(res) should include("Dummy Library")
  }
  
  it should "be able to login from the main page" in new WithApplication(
